...
struct AlertContext {
    ...
    static let invalidScannedType = AlertItem(title: "Invalid Scanned Type", message: "The value scanned is not valid. The app scans EAN-8 and EAN-13", dismissButton: .default(Text("OK")))
}
